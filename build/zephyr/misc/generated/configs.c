...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_AVIA_HX711_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_CONNECTIVITY_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_CONNECTIVITY_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HX711, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HX711_OFFSET, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HX711_SLOPE_INTEGER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HX711_SLOPE_DECIMAL, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HX711_CALIBRATION_WEIGHT, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HX711_RATE_10HZ, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HX711_SAMPLING_RATE, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HX711_GAIN_128X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HX711_GAIN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_HX711_MODULE, 1);
